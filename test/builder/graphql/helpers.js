...
class SpecBuilder {
  ...
  constructor(nodes, options = {}) {
    ...
    this.knownScalarFieldNames.add('id');
    this.knownScalarFieldNames.add('__typename');
...
export function createSpecBuilderClass(typeName, fieldDescriptions) {
  ...
  // ID and typename fields are used internally by Relay. Always provide reasonable defaults for these, even if they
  // aren't included in fieldDescriptions explicitly.
  installDefaultGetter('id', nextID),
  installDefaultGetter('__typename', typeName);
