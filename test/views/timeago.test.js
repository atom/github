...
describe('Timeago component', function() {
  describe('long time display calcuation', function() {
    ...
    test(
      ...
      'long',
      m => m.subtract(45, 'seconds'),
      'a minute ago',
    );
    test(
      'items within two minutes',
      'long',
      m => m.subtract(2, 'minutes'),
      '2 minutes ago',
    );
    test(
      'items within five minutes',
      'long',
      m => m.subtract(5, 'minutes'),
      '5 minutes ago',
    );
    test(
      'items within thirty minutes',
      'long',
      m => m.subtract(30, 'minutes'),
      '30 minutes ago',
    );
    test(
      'items within an hour',
      'long',
      m => m.subtract(1, 'hours'),
      'an hour ago',
    );
    test(
      'items within the same day',
      'long',
      m => m.subtract(20, 'hours'),
      '20 hours ago',
    );
    test('items within a day', 'long', m => m.subtract(1, 'day'), 'a day ago');
    test(
      'items within the same week',
      'long',
      m => m.subtract(4, 'days'),
      '4 days ago',
    );
    test(
      'items within the same month',
      'long',
      m => m.subtract(20, 'days'),
      '20 days ago',
    );
    test(
    ...
    test(
      'items beyond a month',
      'long',
      m => m.subtract(31, 'days'),
      'on Apr 5th, 1987',
    );
    test(
      'items way beyond a month',
      'long',
      m => m.subtract(2, 'years'),
      'on May 6th, 1985',
    );
  });
