...
import PullRequestCommentsView, {
  PullRequestCommentView,
} from '../../lib/views/pr-review-comments-view';
  ...
  it('adjusts the position for comments after hunk headers', function() {
    ...
    const wrapper = shallow(
      <PullRequestCommentsView
        ...
        reviews={pr.reviews}
        commentThreads={pr.commentThreads}
      />,
    );
...
describe('PullRequestCommentView', function() {
  ...
  const commentUrl =
    'https://github.com/kuychaco/test-repo/pull/4#discussion_r244214873';
  ...
  function buildApp(commentOverrideProps = {}, opts = {}) {
    ...
    return <PullRequestCommentView {...props} />;
  }
  ...
  it('renders the PullRequestCommentReview information', function() {
    ...
    assert.strictEqual(
      githubDotcomMarkdown.prop('switchToIssueish'),
      switchToIssueish,
    );
  });
