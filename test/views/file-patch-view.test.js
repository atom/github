  ...
  describe.only('mouse selection', () => {
    ...
    it('allows lines and hunks to be selected via shift-clicking', async () => {
      ...
      const hunk2 = new Hunk(15, 17, 1, 4, '', [
        new HunkLine('line-15', 'added', -1, 15),
        new HunkLine('line-16', 'added', -1, 18),
        new HunkLine('line-17', 'added', -1, 19),
        new HunkLine('line-18', 'added', -1, 20),
      ]);
      const hunkViews = new Map();
      function registerHunkView(hunk, view) { hunkViews.set(hunk, view); }
      ...
      // in line selection mode, shift-click line in separate hunk
      await hunkView0.props.mousedownOnLine({detail: 1}, hunk0, hunk0.lines[2]);
      await filePatchView.mouseup();
      ...
      await hunkView2.props.mousedownOnLine({detail: 1, shiftKey: true}, hunk2, hunk2.lines[2]);
      await filePatchView.mouseup();
      ...
      await hunkView1.props.mousedownOnLine({detail: 1, shiftKey: true}, hunk1, hunk1.lines[2]);
      await filePatchView.mouseup();
      ...
      // in line selection mode, shift-click hunk header for separate hunk
      await hunkView0.props.mousedownOnLine({detail: 1}, hunk0, hunk0.lines[2]);
      await filePatchView.mouseup();
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set([hunk0.lines[2]]));
      await hunkView2.props.mousedownOnHeader({shiftKey: true}, hunk2);
      await filePatchView.mouseup();
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0, hunk1, hunk2]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set([...hunk0.lines.slice(2), ...hunk1.lines, ...hunk2.lines]));
      await hunkView1.props.mousedownOnHeader({shiftKey: true}, hunk1);
      await filePatchView.mouseup();
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0, hunk1]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set([...hunk0.lines.slice(2), ...hunk1.lines]));

      // line mode, shift click hunk
      // hunk mode, shift click line
      // hunk mode, shift click hunk
    });

    it.only('allows lines and hunks to be selected via cmd-clicking', async () => {
      const hunk0 = new Hunk(1, 1, 2, 4, '', [
      ...
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set([hunk0.lines[2]]));
      await hunkView1.props.mousedownOnLine({detail: 1, metaKey: true}, hunk1, hunk1.lines[2]);
      await filePatchView.mouseup();
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0, hunk1]));
      ...
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set([hunk0.lines[2]]));
      await hunkView1.props.mousedownOnHeader({metaKey: true});
      await filePatchView.mouseup();
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0, hunk1]));
      ...
      assertEqualSets(filePatchView.getSelectedHunks(), new Set([hunk0]));
      assertEqualSets(filePatchView.getSelectedLines(), new Set(hunk0.lines));
      // line mode, cmd click line
      // line mode, cmd click hunk
      // hunk mode, cmd click line
      // hunk mode, cmd click hunk
    });
  });
