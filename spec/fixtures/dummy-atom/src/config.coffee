...
class Config
  ...
  # Extended: Get some of the values for the given key-path, along with their
  # associated scoped selector.
  #
  # * `keyPath` The {String} name of the key to retrieve
  # * `options` (optional) {Object} see the `options` argument to {::get}
  #
  # Returns annnnn {Array} of {Object}s with the following keys:
