...
export default class FileList {
  ...
  //
  // * Let's say there is a Diff tab being deserialized for `config.js`. The
  // deserializer runs before nodegit knows the state of things, but the tab
  // needs a model. The tab will use `getOrCreateFileFromPathName` to get the
  // model.
  // * Then and the FileDiff::loadFromGitUtils is called and there are changes
  // in `config.js` * `loadFromGitUtils` will use
