...
export default class GitShellOutStrategy {
  ...
  commit(message, {allowEmpty, amend} = {}) {
    ...
    return this.exec(args, {writeOperation: true, useGitPromptServer: true});
  }
   ...
   */
  merge(branchName) {
    return this.exec(['merge', branchName], {writeOperation: true, useGitPromptServer: true});
  }
  ...
  pull(remoteName, branchName) {
    return this.exec(['pull', remoteName, branchName], {useGitPromptServer: true, writeOperation: true});
  }
