...
// Track an operation that may be either enabled or disabled with a message and a reason. MaybeOperation instances are
// immutable to aid passing them as React comopnent props; call `.enable()` or `.disable()` to derive a new operation
// instance with the same callback.
export default class MaybeOperation {
