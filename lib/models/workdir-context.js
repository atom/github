...
export default class WorkdirContext {
  ...
  constructor(directory, options = {}) {
    ...
    const {repository, window: theWindow, workspace, promptCallback} = options;
    ...
    this.repository = repository || new Repository(directory);
...
export class NullWorkdirContext extends WorkdirContext {
  constructor(directory) {
    super(directory, {dormant: DORMANT});
  }
