...
export default class Patch {
  ...
  static createDelayedPatch(position, renderStatus, parseFn) {
    return new DelayedPatch(position, renderStatus, parseFn);
  }

  constructor({status, hunks, marker, renderStatus}) {
    this.status = status;
    this.hunks = hunks;
    this.marker = marker;
