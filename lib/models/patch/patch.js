...
const emptyTextBuffer = new TextBuffer();

const emptyTextBufferLayers = {
  hunk: emptyTextBuffer.addMarkerLayer(),
  unchanged: emptyTextBuffer.addMarkerLayer(),
  addition: emptyTextBuffer.addMarkerLayer(),
  deletion: emptyTextBuffer.addMarkerLayer(),
  noNewline: emptyTextBuffer.addMarkerLayer(),
};
...
export const nullPatch = {
  ...
  getBuffer() {
    return emptyTextBuffer;
  },

  getHunkLayer() {
    return emptyTextBufferLayers.hunk;
  },

  getUnchangedLayer() {
    return emptyTextBufferLayers.unchanged;
  },

  getAdditionLayer() {
    return emptyTextBufferLayers.addition;
  },

  getDeletionLayer() {
    return emptyTextBufferLayers.deletion;
  },

  getNoNewlineLayer() {
    return emptyTextBufferLayers.noNewline;
  },
