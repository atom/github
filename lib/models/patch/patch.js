...
export default class Patch {
  ...
  static createDelayedPatch(diff, insertPoint) {
    return new DelayedPatch(diff, insertPoint);
  }
...
class DelayedPatch extends NullPatch {
  ...
  getStartRange() {
    return new Range(this.insertPoint, this.insertPoint);
  }
