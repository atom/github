...
export default class Repository {
  constructor(workingDirectoryPath, gitStrategy = null) {
    ...
    if (workingDirectoryPath !== ABSENT_TOKEN) {
      ...
      this.loadPromise = Promise.reject(new Error('An absent repository will never load'));
      this.transitionTo(AbsentState);
    }
  }

  static absent() {
    return new Repository(ABSENT_TOKEN);
  }
