...
export default class Repository {
  ...
  storeBeforeAndAfterBlobs(filePaths, isSafe, destructiveAction, {partial} = {}) {
    return this.discardHistory.storeBlobs(filePaths, isSafe, destructiveAction, partial);
  }

  undoLastDiscardInTempFiles(isSafe, {partial, filePath} = {}) {
    return this.discardHistory.undoLastDiscardInTempFiles(isSafe, {partial, filePath});
  }
  ...
  popUndoHistoryForFileDiscards() {
    return this.discardHistory.popUndoHistoryForFileDiscards();
  }
  ...
  clearWholeFileDiscardHistory() {
    return this.discardHistory.clearWholeFileDiscardHistory();
  }
  ...
  getFileDiscardUndoHistory() {
    return this.discardHistory.getFileDiscardUndoHistory();
  }

  @autobind
  getLastHistorySnapshotsForFileDiscards() {
    return this.discardHistory.getLastHistorySnapshotsForFileDiscards();
  }
