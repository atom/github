...
// Internal tokens used to designate the initial state of a Repository.
const ABSENT = {};
const UNDETERMINED = {};
const LOADING = {};

// Tokens used to control the behavior of the Undetermined state.
export const ABSENTLIKE = {};
export const LOADINGLIKE = {};
...
export default class Repository {
  constructor(workingDirectoryPath, gitStrategy = null, initialState = LOADING, ...stateArgs) {
    ...
    this.transitionTo(getStateConstructor(initialState), ...stateArgs);
  }
  ...
  static undetermined(behavior) {
    return new Repository(null, null, UNDETERMINED, behavior === LOADINGLIKE);
  }
