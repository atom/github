...
import {InitialState, AbsentState} from './repository-states';
...
export default class Repository {
  constructor(workingDirectoryPath, gitStrategy = null) {
    ...
    this.transitionTo(workingDirectoryPath !== ABSENT ? InitialState : AbsentState);
  }

  static absent() {
    return new Repository(ABSENT);
  }
  ...
  getLoadPromise() {
    return this.isAbsent() ? this.loadPromise : Promise.reject(new Error('An absent repository will never load'));
  }
