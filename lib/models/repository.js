...
export default class Repository {
  ...
  storeBeforeAndAfterBlobs(filePath, destructiveAction) {
    return this.fileDiscardHistory.storeBlobs(filePath, destructiveAction);
  }

  attemptToRestoreBlob(filePath) {
    return this.fileDiscardHistory.attemptToRestoreBlob(filePath);
  }
