...
export default class Repository {
  ...
  constructor(workingDirectoryPath, gitStrategy, history) {
    ...
    this.fileDiscardHistory = new FileDiscardHistory(this.createBlob, this.restoreBlob, this.mergeFile, this.setConfig);
  ...
  @autobind
  mergeFile(currentPath, basePath, otherPath) {
    return this.git.mergeFile(currentPath, basePath, otherPath);
  }
  ...
  undoLastDiscardInTempFile(filePath, isSafe) {
    return this.fileDiscardHistory.undoLastDiscardInTempFile(filePath, isSafe);
  }
  ...
  getLastHistorySnapshotsForPath(filePath) {
    return this.fileDiscardHistory.getLastHistorySnapshotsForPath(filePath);
  }
}
