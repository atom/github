...
export default class Repository {
  static async open(workingDirectory, gitStrategy) {
    const strategy = gitStrategy || new GitShellOutStrategy(workingDirectory.getPath());
    if (await strategy.isGitRepository(workingDirectory)) {
      return new Repository(workingDirectory, strategy);
    } else {
      return null;
    }
  }
