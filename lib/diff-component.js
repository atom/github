...
export default class DiffComponent {
  constructor ({diffViewModel}) {
    ...
    atom.commands.add(this.element, 'core:move-up', () => {
      this.diffViewModel.moveSelectionUp()
    })
    atom.commands.add(this.element, 'core:move-down', () => {
      this.diffViewModel.moveSelectionDown()
    })
    atom.commands.add(this.element, 'git:expand-selection-up', () => {
      this.diffViewModel.expandSelectionUp()
    })
    atom.commands.add(this.element, 'git:expand-selection-down', () => {
      this.diffViewModel.expandSelectionDown()
    })
  }
