...
export default class AtomTextEditor extends React.PureComponent {
  static propTypes = {
    ...
    didChangeSelections: PropTypes.func,
  ...
  constructor(props, context) {
    super(props, context);
    autobind(this, 'didChange', 'didChangeCursorPosition', 'didChangeSelections');
  ...
  componentDidMount() {
    ...
    this.refElement.map(element => {
      ...
      this.subs.add(
        ...
        editor.onDidAddSelection(this.didChangeSelections),
        editor.onDidRemoveSelection(this.didChangeSelections),
      );
  ...
  didChangeSelections() {
    this.props.didChangeSelections(this.getModel().getSelections());
  }
