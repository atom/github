...
class BareDecoration extends React.Component {
  ...
  componentDidMount() {
    ...
    this.markerSub = this.props.markableHolder.observe(this.observeParents);
  }
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.markableHolder !== prevProps.markableHolder) {
      ...
      this.markerSub = this.state.markableHolder.observe(this.observeParents);
    }
  ...
  observeParents() {
    ...
    const markerValid = this.props.markableHolder.map(marker => !marker.isDestroyed()).getOr(false);
  ...
  createDecoration() {
    ...
    const marker = this.props.markableHolder.get();
