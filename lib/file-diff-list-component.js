...
export default class FileDiffListComponent {
  constructor ({fileDiffs, didSelectFileDiff, didConfirmFileDiff, selectedFileDiff}) {
    this.fileDiffs = fileDiffs
    this.selectedFileDiff = selectedFileDiff || fileDiffs[0]
  ...
  update ({fileDiffs, selectedFileDiff}) {
    this.fileDiffs = fileDiffs
