...
import PrPaneItemController from './controllers/pr-pane-item-controller';
...
export default class GithubPackage {
  ...
  activate(state = {}) {
    ...
    this.subscriptions.add(
      ...
      this.workspace.addOpener(PrPaneItemController.opener),
    );
  ...
  createPrPaneItem(state) {
    return PrPaneItemController.create(state);
  }
