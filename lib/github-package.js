...
export default class GithubPackage {
  ...
  async cloneRepositoryForProjectPath(remoteUrl, projectPath) {
    ...
    // TODO: do we need to pass pipelineManager? or is this just discarded immediately and recreated later in workdir context
  ...
  getRepositoryForWorkdir(projectPath) {
    return this.guessedContext ? Repository.loadingGuess({pipelineManager: this.pipelineManager}) : this.contextPool.getContext(projectPath).getRepository();
  }
