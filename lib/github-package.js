...
export default class GithubPackage {
  constructor (workspace, project) {
    ...
    this.commitPanelComponent = new CommitPanelComponent({repository: null, workspace, didSelectFilePatch: this.didSelectFilePatch.bind(this)})
  ...
  didSelectFilePatch (filePatch, stagingStatus) {
    ...
    if (this.filePatchComponent) {
      this.filePatchComponent.update({filePatch, repository, stagingStatus})
      ...
      this.filePatchComponent = new FilePatchComponent({filePatch, repository, stagingStatus})
  ...
  destroy () {
    ...
    this.commitPanelComponent.destroy()
  }
}
