...
export default class GithubPackage {
  constructor (workspace, project) {
    ...
    this.commitPanelComponent = new CommitPanelComponent({repository: null, didSelectFileDiff: this.didSelectFileDiff.bind(this)})
  }
  ...
  didSelectFileDiff (fileDiff, stageStatus) {
