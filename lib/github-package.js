...
export default class GithubPackage {
  ...
  async activate(state = {}) {
    ...
    this.subscriptions = new CompositeDisposable();
    this.initialWatchersStartedPromise = this.cacheModelsForPath(this.project.getDirectories().map(dir => dir.getRealPathSync()));
  ...
  projectPathForItemPath(filePath) {
    ...
    return this.project.getDirectories().find(projectDir => {
