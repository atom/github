...
import {TextEditor, Point, Cursor, CompositeDisposable} from 'atom'

import type {ComponentWidget} from 'etch' // eslint-disable-line no-duplicate-imports
...
export default class CommitEditorComponent {
  ...
  getCharacterWidth (): number {
    return this.refs.editor ? this.refs.editor.getDefaultCharWidth() : 6
  }
}
