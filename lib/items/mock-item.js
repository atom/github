      ...
      <div className="github-Reviews">
        ...
        <details className="github-Reviews-section" open>
          ...
          <main className="github-Reviews-container">
            ...
            <div className="github-ReviewSummary is-approving">
              <header className="github-ReviewSummary-header">
                <span className="github-ReviewSummary-icon icon icon-check"></span>
            ...
            <div className="github-ReviewSummary is-requestingChanges">
              <header className="github-ReviewSummary-header">
                <span className="github-ReviewSummary-icon icon icon-alert"></span>
                <img className="github-ReviewSummary-avatar" src="https://avatars.githubusercontent.com/u/e?email=simurai%40github.com&s=32"/>
                <a className="github-ReviewSummary-username" href="https://github.com/simurai">simurai</a>
                <span className="github-ReviewSummary-type">requested changes</span>
                <span className="github-ReviewSummary-timeAgo">2 hours ago</span>
              </header>
              <main className="github-ReviewSummary-comment">
            ...
            <div className="github-ReviewSummary is-commenting">
              <header className="github-ReviewSummary-header">
                <span className="github-ReviewSummary-icon icon icon-comment"></span>
                <img className="github-ReviewSummary-avatar" src="https://avatars.githubusercontent.com/u/e?email=annthurium%40github.com&s=32"/>
                <a className="github-ReviewSummary-username" href="https://github.com/annthurium">annthurium</a>
                <span className="github-ReviewSummary-type">commented</span>
                <span className="github-ReviewSummary-timeAgo">4 hours ago</span>
              </header>
              <div className="github-ReviewSummary-comment">
          ...
          <main className="github-Reviews-container">
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                ...
                data-path="lib/controllers/commit-detail-controller.js" data-line="19">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="lib/controllers/pr-reviews-controller.js" data-line="22">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="lib/models/patch/builder.js" data-line="12">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="lib/models/patch/multi-file-patch.js" data-line="359">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
                <div className="github-Review-diffLine is-added">{ '    }' }</div>
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="lib/views/file-patch-header-view.js" data-line="52">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
            ...
            <details className="github-Review">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="test/views/pr-comments-view.test.js" data-line="17">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
                <div className="github-Review-diffLine is-added">{ '    };' }</div>
            ...
            <details className="github-Review is-resolved">
              ...
              <nav className="github-Review-nav">
                <button className="github-Review-navButton icon icon-code" onClick={this.didClickLink}
                data-path="lib/models/patch/builder.js" data-line="280">Jump to file</button>
                <button className="github-Review-navButton icon icon-diff">View changes</button>
              </nav>
              <pre className="github-Review-diff">
                <div className="github-Review-diffLine is-added">{ '  /*' }</div>
