        ...
        <main className="github-Accordion-content github-Reviews">
          ...
          <div className="github-Review">
            <header className="github-Review-header">
              ...
              <span className="github-Review-type">recommended changes</span>
              <span className="github-Review-headerTimeAgo">2 days ago</span>
            </header>
            ...
            <details className="github-Review-thread">
              <summary className="github-Review-threadHeader">
                <span className="github-Review-path">src/</span>
                <span className="github-Review-file">panel-container-element.js</span>
                <span className="github-Review-line">68</span>
              </summary>
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/06.png"/>
                  <span className="github-Review-commentText">What if someone deliberately sends <code>undefined</code> or <code>null</code>? It seems like those values will get through these two <code>panel.autoFocus</code> guards and possibly cause an error in <code>focusTrap</code>.</span>
                  <span className="github-Review-timeAgo">4 hours ago</span>
                </div>
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/14.png"/>
                  <span className="github-Review-commentText">Nice catch! I updated it so any falsy value will be treated the same as false</span>
            ...
            <details className="github-Review-thread is-resolved">
              <summary className="github-Review-threadHeader">
                <span className="github-Review-resolvedIcon icon icon-check"></span>
                <span className="github-Review-path">src/</span>
                <span className="github-Review-file">workspace.js</span>
          ...
          <div className="github-Review">
            ...
            <details className="github-Review-thread">
              <summary className="github-Review-threadHeader">
                <span className="github-Review-path">src/</span>
                <span className="github-Review-file">panel-container-element.js</span>
                <span className="github-Review-line">58</span>
              </summary>
              <main className="github-Review-comments">
                <div className="github-Review-comment">
                  <img className="github-Review-avatar" src="../../github/img/avatars/04.png"/>
            ...
            <details className="github-Review-thread is-resolved">
              <summary className="github-Review-threadHeader">
                <span className="github-Review-resolvedIcon icon icon-check"></span>
                <span className="github-Review-path">spec/</span>
                <span className="github-Review-file">panel-container-element-spec.js</span>
          ...
          <div className="github-Review">
            <header className="github-Review-header">
              ...
              <span className="github-Review-type">approved these changes</span>
              <span className="github-Review-headerTimeAgo">3 days ago</span>
            </header>
