    ...
    return (
      <header className="github-IssueishDetailView-header">
        <div className="github-IssueishDetailView-headerColumn">
            <a className="github-IssueishDetailView-avatar" href="https://github.com/atom"><img className="github-IssueishDetailView-avatarImage" src="../../github/img/avatars/14.png" title="Shay" alt="Shay" /></a>
        </div>
        <div className="github-IssueishDetailView-headerColumn is-flexible">
            <div className="github-IssueishDetailView-headerRow is-fullwidth"><a className="github-IssueishDetailView-title" href="https://github.com/atom/atom/pull/18705">Enable autoFocus option to accept an element to focus on pane creation</a></div>
            <div className="github-IssueishDetailView-headerRow"><span className="github-IssueishDetailView-headerBadge github-IssueishBadge open"><span className="icon icon-git-pull-request"></span>open</span><span className="icon icon-repo-sync github-IssueishDetailView-headerRefreshButton"></span><a className="github-IssueishDetailView-headerLink" title="open on GitHub.com" href="https://github.com/atom/atom/pull/18705">atom/atom#18705</a><span className="github-IssueishDetailView-headerStatus"></span>
            </div>
        </div>
        <div className="github-IssueishDetailView-headerColumn">
            <button className="btn btn-primary github-IssueishDetailView-checkoutButton github-IssueishDetailView-checkoutButton--current" disabled="true" title="Current">Checked out</button>
        </div>
      </header>
    );
  }
    ...
    return (
      <details className="github-Accordion">
        <summary className="github-Accordion-header">
          ...
          <span className="github-Accordion-headerControls">#18705</span>
        </summary>
        <main className="github-Accordion-content github-Overview">
          <span className="github-IssueishDetailView-meta"><code className="github-IssueishDetailView-baseRefName">atom/master</code> ‹ <code className="github-IssueishDetailView-headRefName">shay/autofocus-element</code></span>
        </main>
      </details>
    );
  }
  ...
  renderCommits() {
    return (
      <details className="github-Accordion">
        ...
        <ul className="github-Accordion-content github-RecentCommits-list">
