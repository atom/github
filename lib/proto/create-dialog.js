      ...
      <form className="github-Dialog github-Create modal padded">
        ...
        <div className="github-Create-destination block">
          <label className="input-label">
            ...
            <div className="github-Create-destinationRow">
              <AtomTextEditor
                className="github-Create-destinationPath"
                mini={true}
                buffer={this.destPathBuffer}
              />
              <button className="btn icon icon-file-directory" />
            </div>
          </label>
        </div>
        <details className="github-Create-advanced block">
          <summary>Advanced</summary>
          <main>
            <div className="github-Create-protocol block">
              <span className="github-Create-protocolHeading">Protocol:</span>
              <label className="github-Create-protocolOption input-label">
            ...
            <div className="github-Create-sourceRemote block">
              <label htmlFor="github-Create-sourceRemoteName">Source remote name:</label>
              <AtomTextEditor
                className="github-Create-sourceRemoteName"
                id="github-Create-sourceRemoteName"
                mini={true}
                autoWidth={false}
