...
export default class PullRequestChangedFilesContainer extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      query prChangedFilesContainer_RawDiffQuery($owner: String!, $repo: String!, $number: Int!) {
      ...
      `}
      render={
        ({props}) => (props ? <MultiFilePatchController
          multiFilePatch={this.buildPatch(props.repository.pullRequest.rawDiff)}
