/**
 * @flow
 * @relayHash 29fcc87bf6e5821998433fa54078ce9c
 */
...
export type prTimelineContainerQueryVariables = {|
  timelineCount: number,
  timelineCursor?: ?string,
  url: any,
|};
export type prTimelineContainerQueryResponse = {|
  +resource: ?{|
    +$fragmentRefs: prTimelineContainer_pullRequest$ref
  |}
|};
*/
...
/*
query prTimelineContainerQuery(
  $timelineCount: Int!
  $timelineCursor: String
  $url: URI!
) {
...
// prettier-ignore
(node/*: any*/).hash = '9f077f784e71ae1c58801246cf9e3b68';
module.exports = node;
