...
export class ReviewCommentsController extends React.Component {
  ...
  //     nextProps.aggregateComments(nextProps.review.id, nextProps.review.comments);
  //   }
  //   return {
  //     props: nextProps,
  //   };
  ...
  constructor(props) {
    super(props);
    console.log('pr-review-container-constructor');
  }

  componentDidMount() {
    this.props.aggregateComments(this.props.review.id, this.props.review.comments);
    console.log('comments!!!', this.props.review.comments);
