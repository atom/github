...
export default class DiffViewModel {
  constructor ({uri, deserializer, title, fileList, pathName, pending}) {
  ...
  openFileAtSelection () {
    ...
    const initialLine = (lineObject.getNewLineNumber() || lineObject.getOldLineNumber()) - 1
