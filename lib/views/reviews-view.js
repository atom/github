...
export default class ReviewsView extends React.Component {
          ...
          <div className="github-Review-replyButtonRow">
            {pendingReview &&
              <button
                ...
                disabled={isPosting}
                onClick={() => this.submitReplyExistingReview(replyHolder, thread, lastComment, pendingReview)}>
            ...
            {!pendingReview &&
              <Fragment>
                ...
                <button
                  ...
                  disabled={isPosting}
                  onClick={() => this.submitReplyStartReview(replyHolder, thread, lastComment)}>
                  Start a review
                </button>
              </Fragment>
            }
  ...
  submitReply(replyHolder, thread, lastComment) {
    ...
    return this.props.addSingleComment(
      body, thread.id, replyToID, lastComment.path, lastComment.position, {didSubmitComment, didFailComment},
    );
  }
