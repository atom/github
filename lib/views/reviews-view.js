      ...
      <div className="github-ReviewSummary" key={review.id}>
        <header className="github-ReviewSummary-header">
          ...
          <img className="github-ReviewSummary-avatar"
            src={review.author ? review.author.avatarUrl : ''} alt={review.login.login}
          />
          <a className="github-ReviewSummary-username" href={`https://github.com/${review.login.login}`}>{review.login.login}</a>
