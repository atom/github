      ...
      <div className="github-ReviewSummary" key={review.id}>
        <header className="github-ReviewSummary-header">
          ...
          {review.lastEditedAt !== null && (
            <span className="github-ReviewSummary-edited">
              &nbsp;•&nbsp;
              <a className="github-ReviewSummary-edited" href={review.url}>edited</a>
            </span>
          ...
          <div className="github-Review-header-authorData">
            ...
            {comment.lastEditedAt !== null && (
              <span className="github-Review-edited">
                &nbsp;•&nbsp;
                <a className="github-Review-edited" href={comment.url}>edited</a>
              </span>
            )}
