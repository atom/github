...
export default class ReviewsView extends React.Component {
    ...
    return (
      <header className="github-Reviews-topHeader">
        ...
        <span className="github-Reviews-headerTitle">
          Reviews for&nbsp;
          <span className="github-Reviews-clickable">
  ...
  renderCheckoutButton() {
    ...
    if (!checkoutOp.isEnabled()) {
      ...
      extraClass = 'github-Reviews-checkoutButton--' + reason.when({
        disabled: 'disabled',
        busy: 'busy',
        current: 'current',
      });
    ...
    const classNames = cx('btn', 'btn-primary', 'github-Reviews-headerButton', extraClass);
    return (
      <button
