...
export default class ReviewsView extends React.Component {
        ...
        <header className="github-Review-header">
          <div className="github-Review-header-authorData">
            ...
            <img className="github-ReviewSummary-avatar"
              src={review.author.avatarUrl} alt={review.author.login}
            />
            <a className="github-ReviewSummary-username" href={review.author.url}>{review.author.login}</a>
  ...
  renderReviewCommentThread = commentThread => {
    ...
    if (rootComment.author === null) {
      rootComment.author = GHOST_USER;
    }
      ...
      <details
        ...
        <summary className="github-Review-reference" onClick={toggle}>
          ...
          <img className="github-Review-referenceAvatar"
            src={rootComment.author.avatarUrl} alt={rootComment.author.login}
          />
        ...
        <header className="github-Review-header">
          <div className="github-Review-header-authorData">
            <img className="github-Review-avatar"
              src={comment.author.avatarUrl} alt={comment.author.login}
            />
            <a className="github-Review-username" href={comment.author.url}>
          ...
          <a className="github-Review-reportAbuseLink" title="report abuse" href={`https://github.com/contact/report-content?report=${encodeURIComponent(comment.author.login)}&content_url=${encodeURIComponent(comment.url)}`}>
            <Octicon icon="alert" />
          </a>
        </header>
