...
export default class ReviewsView extends React.Component {
          ...
          {relayEnvironment =>
            <footer className="github-Review-footer">
              <button
                ...
                onClick={() => this.unresolveReviewThread(thread, relayEnvironment)} >
          ...
          {relayEnvironment =>
            <footer className="github-Review-footer">
              <button
                ...
                onClick={() => this.resolveReviewThread(thread, relayEnvironment)} >
  ...
  resolveReviewThread = (thread, environment) => {
    if (thread.viewerCanResolve) { ResolveReviewThreadMutation(thread.id, environment); }
  }

  unresolveReviewThread = (thread, environment) => {
    if (thread.viewerCanUnresolve) { UnresolveReviewThreadMutation(thread.id, environment); }
  }
}
