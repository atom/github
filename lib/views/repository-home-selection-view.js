...
export class BareRepositoryHomeSelectionView extends React.Component {
  static propTypes = {
    ...
    selectedOwner: PropTypes.string.isRequired,

    // Selection callback
    didChooseOwner: PropTypes.func.isRequired,
  }

  render() {
    const owners = this.getOwners();
    const currentOwner = owners.find(o => o.id === this.props.selectedOwner) || owners[0];
    ...
    return (
      <div className="github-RepositoryHome">
        ...
        <AtomTextEditor mini={true} readOnly={this.props.isLoading} buffer={this.props.nameBuffer} />
      </div>
    );
  }
  ...
  didChangeOwner = owner => this.props.didChooseOwner(owner.id);
}
