...
import {TOO_LARGE, COLLAPSED} from '../models/patch/patch';
    ...
    if (this.props.itemType === IssueishDetailItem) {
      return (
        <PullRequestsReviewsContainer
          ...
          isPatchTooLargeOrCollapsed={this.props.multiFilePatch.isPatchTooLargeOrCollapsed}
        ...
        <Marker invalidate="never" bufferRange={filePatch.getStartRange()}>
          <Decoration type="block" className="github-FilePatchView-controlBlock">
            <FilePatchHeaderView
              ...
              isCollapsed={filePatch.getRenderStatus === TOO_LARGE || filePatch.getRenderStatus === COLLAPSED}
      ...
      <Marker invalidate="never" bufferRange={filePatch.getStartRange()}>
        <Decoration type="block" className="github-FilePatchView-controlBlock">
          <p className="github-FilePatchView-message icon icon-info">
            ...
            <span onClick={showDiff}> Show diff anyway?</span>
          </p>
        </Decoration>
      </Marker>
    );
