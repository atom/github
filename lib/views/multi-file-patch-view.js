...
// todo: should we be using a PullRequestChangedFileItem just to make this consistent?
...
export default class MultiFilePatchView extends React.Component {
  static propTypes = {
    ...
    itemType: PropTypes.oneOf([ChangedFileItem, CommitPreviewItem, CommitDetailItem, PullRequestChangedFilesContainer]).isRequired,
  }
  ...
  renderCommands() {
    if (this.props.itemType === CommitDetailItem || this.props.itemType === PullRequestChangedFilesContainer) {
      return (
