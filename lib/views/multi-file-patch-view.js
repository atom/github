...
export default class MultiFilePatchView extends React.Component {
  ...
  renderPullRequestReviews() {
    if (this.props.itemType === IssueishDetailItem) {
      return <PullRequestsReviewsContainer pullRequest={this.props.pullRequest} multiFilePatch={this.props.multiFilePatch} switchToIssueish={this.props.switchToIssueish} />;
    } else {
      return null;
    }
  }
