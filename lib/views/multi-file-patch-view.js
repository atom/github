...
export default class MultiFilePatchView extends React.Component {
  ...
  renderComments() {
    // 1. need to figure out which file patch the comment belongs to
    // 2. how many hunks since beginning of file till comment
    // 3. filePatch.beginRange + number of hunks + comment.position
