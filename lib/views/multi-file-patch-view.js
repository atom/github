...
import PullRequestCommentsView from './pr-comments-view';
  ...
  renderNonEmptyPatch() {
    return (
      <AtomTextEditor
        ...
        <PullRequestCommentsView reviews={this.props.reviews} multiFilePatch={this.props.multiFilePatch} switchToIssueish={this.props.switchToIssueish}/>
