...
export default class GitPanelView {
  constructor ({workspace, commandRegistry, repository, unstagedChanges, stagedChanges, branchName, remoteName, aheadCount, behindCount, pullEnabled, stageFilePatch, unstageFilePatch, push, pull, fetch}) {
    ...
    this.stageFilePatch = stageFilePatch
    this.unstageFilePatch = unstageFilePatch
    this.push = push
    this.pull = pull
    this.fetch = fetch
  ...
  update ({repository, unstagedChanges, stagedChanges, branchName, remoteName, aheadCount, behindCount, pullEnabled, stageFilePatch, unstageFilePatch, push, pull, fetch}) {
    this.repository = repository
    this.unstagedChanges = unstagedChanges
    this.stagedChanges = stagedChanges
    this.branchName = branchName
