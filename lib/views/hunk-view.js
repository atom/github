...
export default class HunkView {
  ...
  @autobind
  clickOnItem(event, line) {
    return this.props.clickOnItem(event, this.props.hunk, line);
  }
      ...
      <div className={`github-HunkView ${hunkModeClass} ${hunkSelectedClass}`}>
        ...
        {this.props.hunk.getLines().map((line, idx) =>
          <LineView
            ...
            mousedown={e => this.props.mousedownOnLine(e, line)}
  ...
  render() {
    ...
    return (
      <div className={`github-HunkView-line ${lineSelectedClass} is-${line.getStatus()}`}
        onclick={event => this.props.clickOnItem(event, line)}
