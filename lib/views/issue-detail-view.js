...
export class BareIssueDetailView extends React.Component {
  ...
  constructor(props) {
    super(props);
    autobind(this, 'handleRefreshClick', 'refresh', 'renderIssueBody');
  }
  ...
  // would be good to make this more specific in terms of the source component, etc.
...
export default createRefetchContainer(BareIssueDetailView, {
  ...
  issueish: graphql`
    fragment issueDetailView_issueish on IssueOrPullRequest
    @argumentDefinitions(
