...
export class BareIssueDetailView extends React.Component {
  ...
  renderIssueBody(issue, childProps) {
    return (
      <Fragment>
  ...
  render() {
    ...
    const childProps = {
      issue: issue.__typename === 'Issue' ? issue : null,
      pullRequest: issue.__typename === 'PullRequest' ? issue : null,
    };
    return (
      <div className="github-IssueishDetailView native-key-bindings">
        <div className="github-IssueishDetailView-container">
          ...
          {this.renderIssueBody(issue, childProps)}
