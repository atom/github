          ...
          <header className="github-IssueishDetailView-header">
            ...
            {isPr && <div className="github-IssueishDetailView-headerRow">
              <span className="github-IssueishDetailView-meta">
                ...
                <a className="github-IssueishDetailView-commitCount" href={issueish.url + '/commits'}>{issueish.countedCommits.totalCount} commits</a> and{' '}
                <a className="github-IssueishDetailView-fileCount" href={issueish.url + '/files'}>{issueish.changedFiles} changed files</a> into{' '}
                <code>{issueish.baseRefName}</code> from{' '}
                <code>{issueish.headRefName}</code>
              </span>
            </div>}
            <div className="github-IssueishDetailView-headerRow">
              <div className="github-IssueishDetailView-headerGroup">
