        ...
        <div className="github-IssueishDetailView-container">
          ...
          <Tabs>
            <TabList className="github-IssueishDetailView-tablist">
              ...
              {isPr ? <Fragment>
                <Tab className="github-IssueishDetailView-tab">
                  <Octicon icon="checklist" className="github-IssueishDetailView-tab-icon" />Build Status</Tab>
                <Tab className="github-IssueishDetailView-tab">
...
export default createRefetchContainer(BareIssueishDetailView, {
  ...
  (
    $repoId: ID!, $issueishId: ID!, $timelineCount: Int!, $timelineCursor: String, $commitCount: Int!, $commitCursor: String
  ) {
    ...
    issueish:node(id: $issueishId) {
      ...issueishDetailView_issueish @arguments(timelineCount: $timelineCount, timelineCursor: $timelineCursor, commitCount: $commitCount, commitCursor: $commitCursor)
    }
  }
`);
