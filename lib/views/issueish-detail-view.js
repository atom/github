        ...
        <div className="github-IssueishDetailView-container">
          ...
          <Tabs>
            <TabList className="github-IssueishDetailView-tablist">
              <Tab><Octicon icon="info" className="github-IssueishDetailView-tab-icon"/>Overview</Tab>
              <Tab><Octicon icon="checklist" className="github-IssueishDetailView-tab-icon"/>Build Status</Tab>
              <Tab><Octicon icon="diff" className="github-IssueishDetailView-tab-icon"/>Files Changed</Tab>
            </TabList>
            ...
            {/* files changed */}
            <TabPanel>
              {/* todo: add stuff here when Ash's filepatch changes are in */}
            </TabPanel>
          </Tabs>
