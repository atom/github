...
export default class CreatePullRequestTile extends React.Component {
  ...
  render() {
    ...
    if (this.isDetachedHead()) {
      return (
        <div className="github-CreatePullRequestTile-message">
          ...
          <strong>Create a new branch</strong>&nbsp; to share your work with a
          pull request.
        </div>
      );
    }
    ...
    if (this.isOnDefaultRef()) {
      return (
        <div className="github-CreatePullRequestTile-message">
          ...
          <hr className="github-CreatePullRequestTile-divider" />
          <Octicon icon="git-branch" />
          <strong>Checkout or create a new branch</strong>&nbsp; to share your
    ...
    if (this.isSameAsDefaultRef()) {
      return (
        <div className="github-CreatePullRequestTile-message">
          Your current branch <strong>has not moved</strong> from the
          repository's default branch.
          <hr className="github-CreatePullRequestTile-divider" />
          <Octicon icon="git-commit" />
          <strong>Make some commits</strong>&nbsp; to share your work with a
          pull request.
        </div>
      );
    }
      ...
      <div>
        {differentRemote && (
          <div className="github-CreatePullRequestTile-message">
            ...
            <strong>Publish</strong> it to{' '}
            <code>{this.props.remote.getName()}</code> instead?
          </div>
        )}
  ...
  isOnDefaultRef() {
    ...
    return (
      currentBranch.getPush().getRemoteRef() ===
  ...
  isSameAsDefaultRef() {
    ...
    return mainBranches.some(
      branch => branch.getSha() === currentBranch.getSha(),
    );
  }
