...
export default class FilePatchListComponent {
  constructor ({filePatches, didSelectFilePatch, didConfirmFilePatch, selectedFilePatchIndex, debugOffset}) {
  ...
  render () {
    return (
      <div className='git-FileList'>
        <DebuggerComponent data={{selectedFilePatchIndex: this.selectedFilePatchIndex}} style={{left: `${this.debugOffset * 600}px`}} />
