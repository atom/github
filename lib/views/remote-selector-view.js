    ...
    return (
      <div className="github-RemoteSelector">
        ...
        <div className="initialize-repo-description">
          <span>
            This repository has multiple remotes hosted at GitHub.com. Select a
            remote to see pull requests associated with the{' '}
            <strong>{currentBranch.getName()}</strong> branch:
          </span>
        </div>
