...
export default class PaneItem extends React.Component {
  ...
  // getStubItem() {
  //   switch (this.props.stubItemSelector.length) {
  //     case 2:
  //       return StubItem.getElementBySelector(this.props.stubItemSelector[0], this.props.stubItemSelector[1]);
  //     case 3:
  //       return StubItem.getElementBySelectorAndKey(this.props.stubItemSelector[0], this.props.stubItemSelector[1], this.props.stubItemSelector[2]);
  //   }
  // }
  ...
  setupPaneItem() {
    ...
    let stub;
    if (this.props.stubItem) {
      stub = this.props.stubItem;
    }

    if (stub) {
      stub.setRealItem(itemToAdd);
      this.paneItem = stub;
      // this.props.workspace.open(itemToAdd, {
      //   searchAllPanes: true,
      // });
      ...
      this.paneItem = paneContainer.getActivePane().addItem(itemToAdd, {pending: true});
