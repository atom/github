...
export default class ListSelection {
  constructor(options = {}) {
    this.options = {};
    if (options.isItemSelectable) {
      this.options.isItemSelectable = options.isItemSelectable;
    }
  ...
  isItemSelectable(item) {
    if (this.options.isItemSelectable) {
  ...
  setItems(items) {
    ...
    this.selectableItems = items.filter(this.isItemSelectable);
