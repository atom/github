...
export default class BranchMenuView extends React.Component {
  ...
  render() {
    ...
    const iconClasses = cx('github-BranchMenuView-item', 'icon', {'icon-git-branch': !disableControls, 'icon-sync': disableControls});
  ...
  componentWillReceiveProps(nextProps) {
    ...
    const hasNewBranch = branchNames.indexOf(this.state.checkedOutBranch);
  ...
  async createBranch() {
    if (this.state.createNew) {
      ...
      this.setState({createNew: true}, () => {
        console.log(global.element = this.editorElement);
  ...
  @autobind
  async disableControls(branchName) {
