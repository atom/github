...
export default class BranchMenuView extends React.Component {
  ...
  render() {
    ...
    // const branchCheckout = this.props.repository.getOperationStates().checkoutInProgress();
    // if (branchCheckout.inProgress() && branchNames.indexOf(branchCheckout.getName()) === -1) {
    //   branchNames.push(branchCheckout.getName());
    // }
    // const currentBranchName = branchCheckout.getName() || this.props.currentBranch.getName();
