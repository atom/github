    ...
    return (
      <div className="head-ref-force-pushed-event">
        ...
        <span className="head-ref-force-pushed-event-header">
          <span className="username">{actor ? actor.login : 'someone'}</span>{' '}
          force-pushed the {branchPrefix + headRefName} branch from{' '}
