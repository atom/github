    ...
    return (
      <div className="issue timeline-item">
        <div className="info-row">
          ...
          {author && <img className="author-avatar" src={author.avatarUrl} title={comment.author.login} />}
          <span className="comment-message-header">
            {author ? author.login : 'someone'} commented <Timeago time={comment.createdAt} />
          </span>
        </div>
