  ...
  didClickStageButtonForHunk (hunk) {
    if (this.stagingStatus === 'unstaged') {
      if (this.selectedLines) {
        return this.repository.applyPatchToIndex(this.filePatch.getStagePatchForLines(this.selectedLines))
      } else {
        return this.repository.applyPatchToIndex(this.filePatch.getStagePatchForHunk(hunk))
      }
    } else if (this.stagingStatus === 'staged') {
      if (this.selectedLines) {
        return this.repository.applyPatchToIndex(this.filePatch.getUnstagePatchForLines(this.selectedLines))
      } else {
