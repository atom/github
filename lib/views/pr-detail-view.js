...
export class BarePullRequestDetailView extends React.Component {
        ...
        <div className="github-IssueishDetailView-container">
          ...
          <footer className="github-PrDetailView-footer">
            ...
            <span className="github-PrDetailViewReviews">
              <span className="github-PrDetailViewReviews-count">Resolved <span className="github-PrDetailViewReviews-countNr">1</span> of <span className="github-Reviews-countNr">7</span> comments</span>
              <progress class='github-PrDetailViewReviews-progessBar' value='1' max='7'> comments </progress>
            </span>
  ...
  handleOpenReviewsClick = (evt) => {
    const view = atom.views.getView(atom.workspace);
    atom.commands.dispatch(view, 'github:open-mock')
  }
