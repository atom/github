...
export class BarePullRequestDetailView extends React.Component {
      ...
      <div className="github-IssueishDetailView-headerRow">
        <span className="github-IssueishDetailView-meta">
          <a className="github-IssueishDetailView-metaAuthor"
            href={pullRequest.author.url}>{pullRequest.author.login}</a> wants to merge{' '}
          <a className="github-IssueishDetailView-commitCount"
            href={pullRequest.url + '/commits'}>{pullRequest.countedCommits.totalCount} commits</a> and{' '}
          <a className="github-IssueishDetailView-fileCount"
            href={pullRequest.url + '/files'}>{pullRequest.changedFiles} changed files</a> into{' '}
          <code className="github-IssueishDetailView-baseRefName">{pullRequest.isCrossRepository ?
            `${repo.owner.login}/${pullRequest.baseRefName}` : pullRequest.baseRefName}</code> from{' '}
  ...
  renderPullRequestBody(pullRequest, childProps) {
    return (
      <Tabs>
        ...
        {/* commits */}
        <TabPanel>
          <PrCommitsView pullRequest={pullRequest} />
        </TabPanel>
      </Tabs>
    );
  }
  ...
  render() {
    ...
    const childProps = {
      issue: pullRequest.__typename === 'Issue' ? pullRequest : null,
      pullRequest: pullRequest.__typename === 'PullRequest' ? pullRequest : null,
    };
    ...
    return (
      <div className="github-IssueishDetailView native-key-bindings">
        <div className="github-IssueishDetailView-container">
          ...
          {this.renderPullRequestBody(pullRequest, childProps)}
