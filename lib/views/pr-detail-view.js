...
export class BarePullRequestDetailView extends React.Component {
  static propTypes = {
    ...
    changedFilePosition: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  }

  state = {
    refreshing: false,
    // TODO: FIX ME
    selectedTab: this.props.changedFilePath ? 3 : 0,
  }
  ...
  renderPullRequestBody(pullRequest) {
    ...
    return (
      <Tabs selectedIndex={this.state.selectedTab} onSelect={this.onTabSelected}>
