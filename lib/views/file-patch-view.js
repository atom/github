...
export default class FilePatchView extends React.Component {
  ...
  discardHunkSelection(hunk, containsSelection) {
    if (containsSelection) {
      ...
      return this.props.discardRows(this.props.multiFilePatch, changeRows, 'hunk', {eventSource: 'button'});
    }
  }
  ...
  didConfirm() {
    return this.props.toggleRows(this.props.multiFilePatch, this.props.selectedRows, this.props.selectionMode);
  }
