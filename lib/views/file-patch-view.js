...
export default class FilePatchView extends React.Component {
  static propTypes = {
    ...
    onChangeSplitMode: PropTypes.func.isRequired,
    ...
    return (
      <div
        ...
        <header className="github-FilePatchView-header">
          ...
          {this.renderUnifiedSplitSelector()}
  ...
  @autobind
  renderUnifiedSplitSelector() {
    return (
      <span className="btn-group unified-split-selector">
        <button
          className={cx('btn', {selected: !this.props.splitMode})}
          onClick={this.handleClickUnified}>Unified</button>
        <button
          className={cx('btn', {selected: this.props.splitMode})}
          onClick={this.handleClickSplit}>Split</button>
      </span>
    );
  }
  ...
  @autobind
  handleClickUnified() {
    this.props.onChangeSplitMode(false);
  }

  @autobind
  handleClickSplit() {
    this.props.onChangeSplitMode(true);
  }
