...
export default class FilePatchView extends React.Component {
  static propTypes = {
    ...
    getSelectedStagingViewItem: PropTypes.func.isRequired,
  ...
  isSelectedChangedFile() {
    const item = this.props.getSelectedStagingViewItem();
    return item.filePath === this.props.filePath && item.stagingStatus === this.props.stagingStatus;
  }
  ...
  render() {
    ...
    return (
      <div
        ...
        {this.isSelectedChangedFile() && this.registerCommands()}
  ...
  discardSelection() {
    const selectedLines = this.state.selection.getSelectedLines();
    return selectedLines.size ? this.props.discardLines(this.props.filePatch, selectedLines) : null;
  }
