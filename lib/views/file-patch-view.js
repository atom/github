...
export default class FilePatchView extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log('FilePatchView.componentWillReceiveProps: enter');
    ...
    if (hunksChanged) {
      console.log('FilePatchView.componentWillReceiveProps: updating hunks');
      this.setState(prevState => {
        return {
          selection: prevState.selection.updateHunks(nextProps.hunks),
        };
      }, () => {
        console.log('FilePatchView.componentWillReceiveProps: setState() call for hunk update completed');
        nextProps.switchboard.didChangePatch();
      });
    } else {
      console.log('FilePatchView.componentWillReceiveProps: hunks unchanged');
    }
  }
