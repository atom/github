...
export default class FilePatchView extends React.Component {
  static propTypes = {
    ...
    selectNextHunk: PropTypes.func.isRequired,
    selectPreviousHunk: PropTypes.func.isRequired,
    togglePatchSelectionMode: PropTypes.func.isRequired,
  }
  ...
  constructor(props) {
    ...
    autobind(
      this,
      'didMouseDownOnLineNumber', 'didMouseMoveOnLineNumber', 'didMouseUp', 'didConfirm', 'didOpenFile',
      'didChangeSelections', 'oldLineNumberLabel', 'newLineNumberLabel',
    );
  ...
  renderCommands() {
    return (
      <Commands registry={this.props.commands} target={this.refRoot}>
        <Command command="github:toggle-patch-selection-mode" callback={this.props.togglePatchSelectionMode} />
        <Command command="core:confirm" callback={this.didConfirm} />
        <Command command="github:select-next-hunk" callback={this.props.selectNextHunk} />
        <Command command="github:select-previous-hunk" callback={this.props.selectPreviousHunk} />
  ...
  renderNonEmptyPatch() {
    return (
      <AtomTextEditor
        ...
        autoHeight={false}
        readOnly={true}
        didChangeSelections={this.didChangeSelections}
  ...
  didChangeSelections() {
    this.refEditor.map(editor => {
      ...
      this.props.selectedRowsChanged(
        editor.getSelectedBufferRanges().reduce((acc, range) => {
