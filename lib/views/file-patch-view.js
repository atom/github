...
export default class FilePatchView {
  constructor(props) {
    ...
    this.disposables.add(this.props.commandRegistry.add(this.element, {
      ...
      'github:view-corresponding-diff': () => this.props.isPartiallyStaged && this.props.didDiveIntoCorrespondingFilePatch(),
      'github:discard-selected-lines': () => this.discardSelection(),
      'github:undo-last-file-diff-discard': () => this.props.hasUndoHistory && this.props.undoLastDiscard(),
    }));
  }
