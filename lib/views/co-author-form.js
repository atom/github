...
export default class CoAuthorForm extends React.Component {
  ...
  onNameChange = e => this.setState({name: e.target.value}, this.validate)

  onEmailChange = e => this.setState({email: e.target.value}, this.validate)
  ...
  focusFirstInput = () => this.nameInput.focus()
}
