    ...
    return (
      <div className='git-CommitView' ref='CommitView'>
        ...
        <footer className='git-CommitView-bar'>
          ...
          <label className='git-CommitView-label input-label' style={{display: this.props.isMerging ? 'none' : ''}}><input ref='amend' className='input-checkbox' type='checkbox' /> Amend </label>
