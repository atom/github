...
export default class CommitView {
  ...
  constructor(props) {
    ...
    this.registerExpandEditorTooltip();
  }
  ...
  renderHardWrapIcons() {
    ...
    return (
      <div onclick={this.toggleHardWrap} className="github-CommitView-hardwrap">
        <div className={cx('icon', 'no-hardwrap', 'icon-no-newline', {hidden: notApplicable || !hardWrap})} />
        <div className={cx('icon', 'hardwrap', 'icon-arrow-left', {hidden: notApplicable || hardWrap})} />
      </div>
    );
  }
  ...
  registerExpandEditorTooltip() {
    this.expandTooltip = this.props.tooltips.add(this.element.getElementsByClassName('github-CommitView-expandButton')[0], {
      title: 'Expand commit message editor',
      class: 'github-CommitView-expandButton-tooltip',
    });
    this.hardWrapTooltip = this.props.tooltips.add(this.element.getElementsByClassName('github-CommitView-hardwrap')[0], {
