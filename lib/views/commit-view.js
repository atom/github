...
export default class CommitView extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="github-CommitView" ref={this.refRoot.setter}>
        ...
        <Commands registry={this.props.commandRegistry} target=".github-CommitView-commitPreview">
  ...
  cancelNewCoAuthor = () => this.hideNewAuthorForm()
  ...
  didMoveCursor = () => this.forceUpdate()
