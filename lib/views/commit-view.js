...
export default class CommitView {
  ...
  constructor(props) {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      props.commandRegistry.add('atom-workspace', {
        ...
        'github:edit-commit-message-in-editor': this.openCommitEditor,
      }),
    );
  }
  ...
  render() {
    ...
    return (
      <div className="github-CommitView" ref="CommitView">
        <div className={cx('github-CommitView-editor', {hidden: this.props.deactivateCommitBox})}>
          <TextEditor
            ref="editor"
            softWrapped={true}
            ...
            scrollPastEnd={false}
          />
          <button className="github-CommitView-expandButton icon icon-screen-full"></button>
        </div>
  ...
  @autobind
  openCommitEditor() {
    return this.props.openCommitEditor(this.editor && this.editor.getText());
  }
