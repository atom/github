  ...
  constructor(props) {
    ...
    this.subscriptions = new CompositeDisposable(
      ...
      props.tooltips.add(this.element.getElementsByClassName('github-CommitView-info')[0], {
        title: 'Message body will be hard-wrapped to a width of 72 chars.<br>To disable, go to github package settings.',
        class: 'github-CommitView-info-tooltip',
        delay: {hide: 50000000},
      }),
    );

    console.log(global.e = this.element);
  }
      ...
      <div className="github-CommitView" ref="CommitView">
        <div className={cx('github-CommitView-editor', {'is-expanded': this.props.deactivateCommitBox})}>
          <TextEditor
            ...
            scrollPastEnd={false}
          />
          <div className="github-CommitView-info icon icon-info" />
