...
export default class ListView {
  ...
  writeAfterUpdate () {
    ...
    Object.keys(this.refs).forEach(refname => {
      console.log(refname, ' => ', this.refs[refname].element.textContent)
    })
    console.groupEnd('refs')
    if (this.refs.selected) {
      console.log('scrolling into view', this.refs.selected.element.textContent);
      this.refs.selected.element.scrollIntoViewIfNeeded()
    }
  }
