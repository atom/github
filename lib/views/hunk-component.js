...
export default class HunkComponent {
  constructor ({hunk, isSelected, selectedLines, onDidSelectLines, didClickStageButton, stagingMode, registerComponent}) {
    this.hunk = hunk
  ...
  render () {
    ...
    let stageButtonLabel

    if (this.stagingMode === 'stage') {
