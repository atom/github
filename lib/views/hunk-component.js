...
export default class HunkComponent {
  constructor ({hunk, isSelected, selectedLines, onDidSelectLines, onDidClickStagingButton, stagingButtonLabel, registerComponent}) {
    this.hunk = hunk
    this.isSelected = isSelected
    this.selectedLines = selectedLines
    this.didSelectLines = onDidSelectLines
    this.didClickStagingButton = onDidClickStagingButton
  ...
  update ({hunk, isSelected, selectedLines, registerComponent}) {
    this.hunk = hunk
    this.isSelected = isSelected
    this.selectedLines = selectedLines
    if (registerComponent != null) registerComponent(hunk, this) // only for tests
