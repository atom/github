...
export class PrCommitView extends React.Component {
  ...
  openCommitDetailItem = () => {
    return this.props.onBranch ? this.props.openCommit({sha: this.props.item.abbreviatedOid}) : null;
  }
      ...
      <div className="github-PrCommitView-container">
        <div className="github-PrCommitView-commit">
          <h3 className="github-PrCommitView-title">
            <span className={cx('github-PrCommitView-messageHeadline', {clickable: this.props.onBranch})}
