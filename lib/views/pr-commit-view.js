    ...
    return (
      <div className="github-PrCommitView-container">
        <div>
          ...
          {this.props.commit.messageBody ? <button className="github-PrCommitView-btn" onClick={this.toggleShowCommitMessageBody}>{this.state.showMessageBody ? 'hide' : 'show'} more...</button> : null}
          <div>
