  ...
  render() {
    if (this.props.repository.isTooLarge()) {
        ...
        >
          <div ref="noRepoMessage" className="github-Git too-many-changes">
            ...
            <div className="initialize-repo-description">
              The repository at{' '}
              <strong>{this.props.workingDirectoryPath}</strong> has too many
              changed files to display in Atom. Ensure that you have set up an
              appropriate <code>.gitignore</code> file.
            </div>
          </div>
        </div>
      );
      ...
      return (
        ...
        >
          <div ref="noRepoMessage" className="github-Git unsupported-directory">
            ...
            <div className="initialize-repo-description">
              Atom does not support managing Git repositories in your home or
              root directories.
            </div>
          </div>
        </div>
      ...
      const message = this.props.repository.hasDirectory() ? (
        <span>
          Initialize <strong>{this.props.workingDirectoryPath}</strong> with a
          Git repository
        </span>
      ) : (
      ...
      const isLoading =
        this.props.isLoading || this.props.repository.showGitTabLoading();
