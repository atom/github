...
export default class GitTabView {
  ...
  render() {
    if (this.props.repository.isEmpty()) {
      return (
        <div className="github-Panel is-empty" tabIndex="-1">
          <div ref="noRepoMessage" className="github-Panel no-repository">
            ...
            <button onclick={this.initializeRepo} disabled={this.repoCreationInProgress} className="btn btn-primary">
      ...
      const isLoading = this.props.fetchInProgress || this.props.repository.isLoading();
