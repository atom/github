      ...
      return (
        <div className="github-Panel" tabIndex="-1">
          <div ref="noRepoMessage" className="github-Panel no-repository">
            <div>ICON</div>
            <div className="initialize-repo-description">Initialize this project with a Git repository</div>
            <button onclick={this.initializeRepo} disabled={this.repoCreationInProgress} className="btn">
              {this.repoCreationInProgress ? 'Creating repository...' : 'Create repository'}
            </button>
          </div>
        </div>
      );
