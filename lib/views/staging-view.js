...
export default class StagingView {
  constructor (props) {
    ...
    const equalityPredicate = (a, b) => a.getPath() === b.getPath()
    this.multiList = new MultiList([this.props.unstagedChanges, this.props.mergeConflicts || [], this.props.stagedChanges], equalityPredicate)
