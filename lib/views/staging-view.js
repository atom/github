...
export default class StagingView {
  ...
  renderStageAllButton() {
    return <button className="btn icon icon-move-down" onclick={this.stageAll}>Stage All</button>;
  }

  renderUnstageAllButton() {
    return <button className="btn icon icon-move-up" onclick={this.unstageAll}>Unstage All</button>;
  }
