...
export default class StagingView extends React.Component {
  static propTypes = {
    ...
    mergeConflicts: PropTypes.arrayOf(FilePatchItemPropType),
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    if (
      ...
      nextState = {
        ...nextLists,
        selection: prevState.updateLists(nextLists),
      };
    }
  ...
  confirmSelectedItems = async () => {
    console.log('confirmSelectedItems fired');
    ...
    console.log('confirmSelectedItems complete');
  }
  ...
  async mousedownOnItem(event, item) {
    ...
    if (event.button === 0) {
      ...
      console.log('mousedown complete');
    }
  }
