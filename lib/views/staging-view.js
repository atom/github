...
export default class StagingView {
  constructor ({stagedChanges, unstagedChanges, didSelectFilePatch, stageFilePatch, unstageFilePatch}) {
  ...
  update ({stagedChanges, unstagedChanges, stageFilePatch, unstageFilePatch}) {
    this.stagedChanges = stagedChanges
    this.unstagedChanges = unstagedChanges
    this.stageFilePatch = stageFilePatch
    this.unstageFilePatch = unstageFilePatch
      ...
      <div className={`git-StagingView ${ListNames[selectedList]}-changes-focused`} style={{width: 200}} tabIndex='-1'>
        <div className={`git-StagingView-group git-UnstagedChanges ${unstagedClassName}`}>
          ...
          <FilePatchListView
            ...
            toggleFilePatchStagingState={this.stageFilePatch}
        ...
        <div className={`git-StagingView-group git-StagedChanges ${stagedClassName}`}>
          ...
          <FilePatchListView
            ...
            toggleFilePatchStagingState={this.unstageFilePatch}
