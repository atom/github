...
export default class StagingView {
  constructor(props) {
    ...
    this.diveIntoSelection = this.diveIntoSelection.bind(this);
  ...
  // Directly modify the selection to include only the item identified by the file path and stagingStatus tuple. Don't
  // notify didSelectSingleItem() or other callback functions. This is useful to avoid circular callback loops.
