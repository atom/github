...
export default class StagingView extends React.Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (this.header.clientWidth < 365) {
      this.header.classList.add('github-StagingView-header--narrow-width');
    } else {
      this.header.classList.remove('github-StagingView-header--narrow-width');
    }
  }
    ...
    return (
      <div
        ...
        <div className={`github-StagingView-group github-UnstagedChanges ${this.getFocusClass('unstaged')}`}>
          <header ref={c => (this.header = c)} className="github-StagingView-header">
