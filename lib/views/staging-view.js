...
export default class StagingView {
  ...
  renderStageAllButton() {
    return <button className="github-StagingView-headerButton icon icon-move-down" onclick={this.stageAll}>Stage All</button>;
  }

  renderUnstageAllButton() {
    return <button className="github-StagingView-headerButton icon icon-move-up" onclick={this.unstageAll}>Unstage All</button>;
  }
