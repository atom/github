  ...
  reportSelectedItem () {
    ...
    if (this.selection.getActiveListKey() === 'conflicts') {
      if (this.props.didSelectMergeConflictFile) {
        this.props.didSelectMergeConflictFile(this.selection.getHeadItem().getPath())
      }
    } else {
      if (this.props.didSelectFilePatch) {
        this.props.didSelectFilePatch(this.selection.getHeadItem(), this.selection.getActiveListKey())
      }
    }
  }
