...
export default class StagingView {
  constructor (props) {
    ...
    this.subscriptions = atom.commands.add(this.element, {
      ...
      'core:select-up': this.selectPreviousFilePatch.bind(this, {addToExisting: true}),
      'core:select-down': this.selectNextFilePatch.bind(this, {addToExisting: true}),
  ...
  selectPreviousFilePatch ({addToExisting} = {}) {
    this.multiList.selectPreviousItem({addToExisting})
    return etch.update(this)
  }

  selectNextFilePatch ({addToExisting} = {}) {
    this.multiList.selectNextItem({addToExisting})
    return etch.update(this)
  }
