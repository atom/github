import {Emitter, CompositeDisposable, TextBuffer} from 'atom';
  ...
  renderMarker(marker, i) {
    ...
    return (
      <div className="waterfall-row" key={i}>
        <span className="waterfall-row-label" style={{paddingLeft: markerStyle.left + markerStyle.width}}>{marker.label}</span>
