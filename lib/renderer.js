...
const rendererWebContentsId = remote.getCurrentWindow().webContents.id;

ipc.on(`request-git-exec-${rendererWebContentsId}`, (event, webContentsId, data) => {
...
ipc.sendTo(hostWebContentsId, 'renderer-ready', {webContentsId: rendererWebContentsId});
