...
export default class FilePatchController {
  constructor(props) {
    ...
    this.indexOperationInProgress = false;

    this.stageOrUnstageHunk = this.stageOrUnstageHunk.bind(this);
    this.attemptLineStateOperation = this.attemptLineStateOperation.bind(this);
      ...
      return (
        <div className="git-PaneView pane-item">
          <FilePatchView
            ...
            attemptLineStateOperation={this.attemptLineStateOperation}
            hunks={hunks}
  ...
  attemptLineStateOperation(lines) {
    if (this.indexOperationInProgress) {
      return {
    ...
    this.indexOperationInProgress = true;
