...
export default class FilePatchController extends React.Component {
  ...
  constructor(props, context) {
    ...
    autobind(
      this,
      'onRepoRefresh', 'handleShowDiffClick', 'attemptHunkStageOperation', 'attemptFileStageOperation',
      'attemptModeStageOperation', 'attemptSymlinkStageOperation', 'attemptLineStageOperation', 'didSurfaceFile',
      'diveIntoCorrespondingFilePatch', 'focus', 'openCurrentFile', 'discardLines', 'undoLastDiscard', 'hasUndoHistory',
    );
  ...
  getFilePatchForPath(filePath, staged) {
    ...
    return repository.getFilePatchForPath(filePath, {staged});
  }
