...
export default class FilePatchController extends React.Component {
  ...
  render() {
    ...
    {
      oldSymlink: fp.getOldFile().getSymlink(),
      newSymlink: fp.getNewFile().getSymlink(),
  ...
  @autobind
  attemptSymlinkStageOperation({noSwitchboard} = {}) {
    if (this.stagingOperationInProgress) {
      return null;
    }
    ...
    return this.stageOrUnstageSymlinkChange();
  }
