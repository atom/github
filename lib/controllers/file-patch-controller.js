...
export default class FilePatchController extends React.Component {
  ...
  async onRepoRefresh() {
    ...
    let filePatch = await repository.getFilePatchForPath(this.filePath, {staged, amending});
    if (filePatch) {
  ...
  async componentWillReceiveProps(nextProps) {
    if (nextProps.isAmending !== this.props.isAmending) {
      ...
      const filePatch = await repository.getFilePatchForPath(this.filePath, {staged, amending});
