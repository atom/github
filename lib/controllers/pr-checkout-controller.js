...
export default class PullRequestCheckoutController extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    } else if (this.props.childComponentType === 'ReviewsView') {
      return (
        <Fragment>
          <ReviewsView checkoutOp={this.checkoutOp} {...this.props} />
        </Fragment>
      );
    } else {
      return null;
