...
import CloneDialogEmptySearch from '../proto/clone-dialog-empty-search';
import CloneDialogSearchResults from '../proto/clone-dialog-search-results';
import CloneDialogGitHub from '../proto/clone-dialog-github';
import CloneDialogGitHubFork from '../proto/clone-dialog-github-fork';
import CloneDialogGitHubForkExisting from '../proto/clone-dialog-github-fork-existing';
import CloneDialogNonGitHub from '../proto/clone-dialog-nongithub';
import ConnectDialogSearchResults from '../proto/connect-dialog-search-results';
import ConnectDialogGithub from '../proto/connect-dialog-github';
import ConnectDialogNonGitHub from '../proto/connect-dialog-nongithub';
import CreateDialog from '../proto/create-dialog';
...
export default class RootController extends React.Component {
  ...
  renderCommands() {
    ...
    return (
      <Commands registry={this.props.commandRegistry} target="atom-workspace">
        ...
        />
        <Command
          command="github:proto-clone-dialog-empty-search"
          callback={this.dialogPrototypeOpener(CloneDialogEmptySearch)}
        />
        <Command
          command="github:proto-clone-dialog-search-results"
          callback={this.dialogPrototypeOpener(CloneDialogSearchResults)}
        />
        <Command
          command="github:proto-clone-dialog-github"
          callback={this.dialogPrototypeOpener(CloneDialogGitHub)}
        />
        <Command
          command="github:proto-clone-dialog-github-fork"
          callback={this.dialogPrototypeOpener(CloneDialogGitHubFork)}
        />
        <Command
          command="github:proto-clone-dialog-github-fork-existing"
          callback={this.dialogPrototypeOpener(CloneDialogGitHubForkExisting)}
        />
        <Command
          command="github:proto-clone-dialog-nongithub"
          callback={this.dialogPrototypeOpener(CloneDialogNonGitHub)}
        />
        <Command
          command="github:proto-connect-dialog-search-results"
          callback={this.dialogPrototypeOpener(ConnectDialogSearchResults)}
        />
        <Command
          command="github:proto-connect-dialog-github"
          callback={this.dialogPrototypeOpener(ConnectDialogGithub)}
        />
        <Command
          command="github:proto-connect-dialog-nongithub"
          callback={this.dialogPrototypeOpener(ConnectDialogNonGitHub)}
        />
        <Command
          command="github:proto-create-dialog"
          callback={this.dialogPrototypeOpener(CreateDialog)}
        />
      </Commands>
    );
  }
  ...
  renderProtoDialog() {
    const ProtoDialogContent = this.state.protoDialogActive;
    if (!ProtoDialogContent) {
      return null;
    }
    ...
    return (
      <Panel workspace={this.props.workspace} location="modal">
        <Fragment>
          <ProtoDialogContent />
          <Commands registry={this.props.commandRegistry} target=".github-Dialog">
            <Command command="core:cancel" callback={this.dialogPrototypeCloser()} />
          </Commands>
        </Fragment>
      </Panel>
    );
  ...
  dialogPrototypeOpener(ProtoDialogComponent) {
    return () => this.setState({protoDialogActive: ProtoDialogComponent});
  }

  dialogPrototypeCloser() {
    return () => this.setState({protoDialogActive: null});
  }
