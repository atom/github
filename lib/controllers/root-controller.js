...
export default class RootController extends React.Component {
  ...
  constructor(props, context) {
    ...
    autobind(
      ...
      'showWaterfallDiagnostics', 'showCacheDiagnostics', 'acceptClone', 'cancelClone',
  ...
  renderDialogs() {
    return (
      <Fragment>
        <DialogsController workspace={this.props.workspace} request={this.state.dialogRequest} />
