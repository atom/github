    ...
    return (
      <div>
        <Commands registry={this.props.commandRegistry} target="atom-workspace">
          <Command
            command="github:simurai-username-password"
            callback={() => this.promptForCredentials({
              prompt: 'Example with username and password',
              includeUsername: true,
            })}
          />
          <Command
            command="github:simurai-password-only"
            callback={() => this.promptForCredentials({
              prompt: 'Example with password only',
