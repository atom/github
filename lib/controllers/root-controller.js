...
export default class RootController extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      issueishDetailSelectedTab: null,
    };
        ...
        <PaneItem workspace={this.props.workspace} uriPattern={IssueishDetailItem.uriPattern}>
          {({itemHolder, params}) => (
            <IssueishDetailItem
              ...
              selectedTab={this.state.issueishDetailSelectedTab !== null ?
                this.state.issueishDetailSelectedTab : (parseInt(params.selectedTab, 10) || 0)}
              onTabSelected={index => this.setState({issueishDetailSelectedTab: index})}
            />
          )}
        </PaneItem>
        <PaneItem workspace={this.props.workspace} uriPattern={ReviewsItem.uriPattern}>
          {({itemHolder, params}) => (
            <ReviewsItem
              ...
              config={this.props.config}
              commands={this.props.commandRegistry}
              notifications={this.props.notificationManager}
            />
          )}
        </PaneItem>
