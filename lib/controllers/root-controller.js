...
export default class RootController extends React.Component {
  ...
  renderCommands() {
    ...
    return (
      <Commands registry={this.props.commandRegistry} target="atom-workspace">
        ...
        <Command command="github:open-mock" callback={this.openMock} />
  ...
  renderPaneItems() {
    return (
      <Fragment>
        <PaneItem
          workspace={this.props.workspace}
          uriPattern={MockItem.uriPattern}
          className="github-Git-root">
          {({itemHolder}) => (
            <MockItem workspace={this.props.workspace} ref={itemHolder.setter}/>
          )}
        </PaneItem>
        <PaneItem
          workspace={this.props.workspace}
  ...
  openMock() {
    this.props.workspace.open(MockItem.buildURI());
  }
