...
export default class CommitViewController extends React.Component {
  static focus = {
    ...CommitView.focus,
  }
  ...
  static propTypes = {
    ...
    mergeMessage: PropTypes.string.isRequired,
    ...
    didMoveUpOnFirstLine: PropTypes.func.isRequired,
  }
