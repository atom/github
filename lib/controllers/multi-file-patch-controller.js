...
export default class MultiFilePatchController extends React.Component {
  ...
  openFile = async (filePatch, positions, pending) => {
  ...
  toggleRows = async (rowSet, nextSelectionMode) => {
  ...
  discardRows = async (rowSet, nextSelectionMode, {eventSource} = {}) => {
