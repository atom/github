...
import PullRequestCheckoutOp from '../models/pr-checkout-op';
...
export class BareIssueishDetailController extends React.Component {
  ...
  constructor(props) {
    ...
    // todo: This is kinda gross. Pass only the attributes we need.
    this.checkoutOp = new PullRequestCheckoutOp({...this.props});
  ...
  render() {
    ...
    this.checkoutOp = this.checkoutOp.nextCheckoutOp();
    if (this.state.typename === 'PullRequest') {
      return (
