...
export default class EditorConflictController extends React.Component {
  ...
  constructor(props, context) {
    ...
    this.props.resolutionProgress.reportMarkerCount(props.editor.getPath(), this.state.conflicts.length);
  }
  ...
  resolveAs(conflict, source) {
    ...
    this.props.resolutionProgress.markerWasResolved(this.props.editor.getPath());
  }
}
