...
export default class HubTabController extends React.Component {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div className="github-HubTabController">
        <div className="github-HubTabController-content">
  ...
  renderNoRemotes() {
    return (
      <div className="github-HubTabController-no-remotes">
