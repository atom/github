...
export default class EditorCommentDecorationsController extends React.Component {
  ...
  shouldComponentUpdate(nextProps) {
    const currentTranslations = this.props.commentTranslationsForPath.fileTranslations;
    const nextTranslations = nextProps.commentTranslationsForPath.fileTranslations;
    const currentDigest = currentTranslations ? currentTranslations.digest : '';
    const nextDigest = nextTranslations ? nextTranslations.digest : '';
    console.log(this.props.editor.getPath(), currentDigest, nextDigest);
