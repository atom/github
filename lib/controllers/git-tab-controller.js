...
export default class GitTabController {
  ...
  constructor(props) {
    ...
    this.lastFocus = GitTabController.focus.DEFAULT;
  ...
  rememberLastFocus(event) {
    this.lastFocus = this.refs.gitTab.rememberFocus(event) || GitTabController.focus.DEFAULT;
  }

  restoreFocus() {
    this.refs.gitTab.restoreFocus(this.lastFocus);
  }
