...
export default class GitPanelController {
  constructor(props) {
    ...
    this.attemptStageOrUnstageFilesOperation = this.attemptStageOrUnstageFilesOperation.bind(this);
  ...
  render() {
    ...
    return (
      <GitPanelView
        ...
        attemptStageOrUnstageFilesOperation={this.attemptStageOrUnstageFilesOperation}
        commit={this.commit}
  ...
  attemptStageOrUnstageFilesOperation(filePaths, stageStatus) {
