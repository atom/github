...
export default class GitPanelController {
  constructor (props) {
    ...
    this.addPathToIndex = this.addPathToIndex.bind(this)
    ...
    if (this.repository) {
      return (
        <GitPanelView
          ...
          addPathToIndex={this.addPathToIndex}
          commit={this.commit}
  ...
  async addPathToIndex (filePath) {
    ...
    return this.repository.addPathToIndex(filePath)
  }
