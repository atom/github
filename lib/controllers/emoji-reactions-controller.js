...
export class BareEmojiReactionsController extends React.Component {
  ...
  addReaction = content => addReactionMutation(this.props.relay.environment, this.props.reactable.id, content);

  removeReaction = content => removeReactionMutation(this.props.relay.environment, this.props.reactable.id, content);
}
