...
export default class StatusBarTileController {
  ...
  checkout (branchName, options) {
    return this.repositoryObserver.getActiveRepository().checkout(branchName, options)
  }
  ...
  hideBranchMenu () {
    this.branchMenuView.element.remove()
    this.showingBranchMenuView = false
  }

  showBranchMenu () {
    document.body.appendChild(this.branchMenuView.element)
    new Tether({
      element: this.branchMenuView.element,
      target: this.refs.branchView.element,
