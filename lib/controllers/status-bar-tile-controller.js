    ...
    return (
      <span>
        <Commands registry={this.props.commandRegistry} target="atom-workspace">
          ...
          <Command
            command="github:push"
            callback={() => this.push({force: false, setUpstream: !repoProps.currentRemote.isPresent()})}
          />
          <Command
            command="github:force-push"
            callback={() => this.push({force: true, setUpstream: !repoProps.currentRemote.isPresent()})}
          />
        </Commands>
        <BranchView
