...
export class BareReviewsController extends React.Component {
      ...
      <PullRequestCheckoutController
        ...
        {checkoutOp => (
          <ReviewsView
            ...
            uncreatedThreadPositions={this.props.uncreatedThreadPositions}
  ...
  addCommentToReview = async (reviewID, commentBody, threadID, replyToID, path, position, state = 'PENDING', callbacks = {}) => {
