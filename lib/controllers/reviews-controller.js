...
export class BareReviewsController extends React.Component {
  static propTypes = {
    ...
    commentTranslations: PropTypes.object.isRequired,
  ...
  openFile = (filePath, lineNumber) => {
    const translationMap = this.props.commentTranslations.get(filePath).diffToFilePosition;

    this.props.workspace.open(
      filePath, {
        initialLine: translationMap.get(parseInt(lineNumber, 10)) - 1,
        initialColumn: 0,
        pending: true,
      });
