...
export class BareReviewsController extends React.Component {
  ...
  updateComment = async (commentId, commentBody, callback) => {
    try {
      ...
      this.props.reportMutationErrors('Unable to update comment', error);
    }
  }

  updateSummary = async (reviewId, reviewBody, callback) => {
    try {
      ...
      this.props.reportMutationErrors('Unable to update review summary', error);
    }
  }
}
