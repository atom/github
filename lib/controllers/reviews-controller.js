...
export class BareReviewsController extends React.Component {
  ...
  addCommentToReview = async (reviewID, commentBody, threadID, replyToID, path, position, callbacks = {}) => {
  ...
  replyToStartReview = async (commentBody, threadID, replyToID, path, position, callbacks = {}) => {
    ...
    try {
      ...
      await this.addCommentToReview(reviewID, commentBody, threadID, replyToID, path, position, callbacks);
