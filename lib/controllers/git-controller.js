...
export default class GitController extends React.Component {
        ...
        <Resizer
          ...
          <EtchWrapper
            ...
            <GitPanelController
              ...
              checkoutPathsAtRevision={this.checkoutPathsAtRevision}
            />
          </EtchWrapper>
        </Resizer>
      </Panel>
  ...
  @autobind
  checkoutPathsAtRevision(filePaths) {
    return this.props.repository.checkoutPathsAtRevision(filePaths, 'HEAD');
  }
}
