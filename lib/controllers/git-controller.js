...
import GithubPanelController from './github-panel-controller';
...
export default class GitController extends React.Component {
  ...
  renderGitPanel() {
    let panelClassName = 'github-PanelPortal';
    if (!this.props.githubEnabled) {
      panelClassName += ' githubDisabled';
    }
    return (
      <Panel
        workspace={this.props.workspace}
        ...
        <Tabs className="github-PanelTabs">
          <Tabs.Panel title="Git">
            <EtchWrapper
              ref={c => { this.gitPanelController = c; }}
              reattachDomNode={false}
              className="etch-wrapper-git-panel-controller">
              <GitPanelController
                workspace={this.props.workspace}
          ...
          <Tabs.Panel title="Hub">
            <GithubPanelController repository={this.props.repository} />
          </Tabs.Panel>
        </Tabs>
      </Panel>
    );
