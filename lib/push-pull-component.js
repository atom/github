...
export default class PushPullComponent {
  ...
  renderError () {
    ...
    return (
      <div className='git-Bar git-Error'>
        <span className='git-Bar-item git-Error-name'>
          <span className='icon icon-alert'/>
          {error.name}
        </span>
        <span className='git-Bar-item is-flexible git-Error-message'>
          {error.message}
        </span>
      </div>
    )
  ...
  renderProgress () {
    ...
    return (
      <div className='git-Bar is-addon'>
        <progress className='git-Bar-item is-flexible'/>
      </div>
    )
  }
  ...
  render () {
    ...
    return (
      <div className='git-Panel-item'>
        <div className='git-Bar git-PushPull '>
          <span className='git-Bar-item icon icon-mark-github'/>
          <button className='git-Bar-item btn' onclick={() => this.fetch()}>Fetch</button>

          <div className='git-Bar-item is-flexible btn-group'>
