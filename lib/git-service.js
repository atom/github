...
import {GitRepositoryAsync, CompositeDisposable, Emitter} from 'atom'
...
export default class GitService {
  ...
  _calculatePatchText (hunk: DiffHunk, selectedLines: Array<HunkLine>, offset: number, stage: boolean): {patchText: string, offset: number} {
    ...
    const hunkLineCount = hunkLines.length
    ...
    if (hunkLineCount === selectedLineCount || hunkLineCount === selectedLineCount + 1) {
